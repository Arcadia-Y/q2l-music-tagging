...
class Solver(object):
    ...
    def build_model(self):
        ...
        if self.lr >= 5e-5:
            ...
            self.optimizer = torch.optim.SGD(self.model.parameters(), self.lr, momentum=0.9, weight_decay=0.0001, nesterov=True)

        # scheduler
        self.scheduler = torch.optim.lr_scheduler.OneCycleLR(self.optimizer, max_lr=self.lr, steps_per_epoch=len(self.data_loader), epochs=self.n_epochs, pct_start=0.2)
